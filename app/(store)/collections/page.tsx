...
const certifications = ["All", ...Array.from(new Set(products.map((product) => product.certification)))];
const gemstones = ["All", ...Array.from(new Set(products.map((product) => product.gemstone)))];
const metals = Array.from(new Set(products.map((product) => product.metalType)));
...
export default function CollectionsPage() {
  ...
  }, [activeCategory, inStockOnly, maxPrice, selectedCertification, selectedGemstone, selectedMetals, sortBy]);
                        ...
                        <button
                          ...
                          className={`block w-full rounded-xl px-3 py-2 text-left text-sm transition ${
                            active
                              ...
                              : "text-royal-700/85 hover:bg-white"
                          }`}
                          role="option"
